...
const perft_tests: [string, string, number, number, number, number?, number?][] = [
  ...
  // ['pos-2', 'r1ba1a3/4kn3/2n1b4/pNp1p1p1p/4c4/6P2/P1P2R2P/1CcC5/9/2BAKAB2 w - - 0 1', 38, 1128, 43929, 1_339_047,  53_112_976],
  ...
  // ['pos-5', 'CRN1k1b2/3ca4/4ba3/9/2nr5/9/9/4B4/4A4/4KA3 w - - 0 1',                   28,  516, 14808,   395_483,  11_842_230],
  // ['pos-6', 'R1N1k1b2/9/3aba3/9/2nr5/2B6/9/4B4/4A4/4KA3 w - - 0 1',                   21,  364,  7626,   162_837,   3_500_505],
  // ['pos-7', 'C1nNk4/9/9/9/9/9/n1pp5/B3C4/9/3A1K3 w - - 0 1',                          28,  222,  6241,    64_971,   1_914_306],
  // ['pos-8', '4ka3/4a4/9/9/4N4/p8/9/4C3c/7n1/2BK5 w - - 0 1',                          23,  345,  8124,   149_272,   3_513_104]
];
...
test('checks', () => {
  ...
  const pos1 = Xiangqi.fromSetup(parseFen('9/4k4/9/2N6/9/9/9/4R4/4C4/4K4 b - - 0 1').unwrap()).unwrap();
  expect(pos1.isCheck()).toBe(true);
  expect(isImpossibleCheck(pos1)).toBe(false);

  // quadruple check is possible
  const pos2 = Xiangqi.fromSetup(parseFen('4k4/3PR1N2/5N3/4C4/9/9/9/9/9/4K4 b - - 0 1').unwrap()).unwrap();
